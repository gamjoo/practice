...
public class Student_Make_Solution_Array_Sort {
	public static void main(String[] args) {
		/*
		 * Student h1 = new Student("강호동", 85, 60, 70); Student h2 = new Student("이승기",
		 * 90, 95, 80); Student h3 = new Student("유재석", 75, 80, 100); Student h4 = new
		 * Student("하하", 80, 70, 95); Student h5 = new Student("이광수", 100, 65, 80);
		 */
		// int[] a = {1,2,3};
...
//		students[4] = new Student("이광수", 100, 65, 80);
	...
	/////////////// 지금 한 결과로 덩어리 자체가 바뀐 것이다. student의 순서가 총점기준 내림차순으로 
