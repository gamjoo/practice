 ...
 *  -데이터의 추가 또는 삭제시 ArrayList보다 속도가 빠르다.
 *	 ArrayList의 경우 차례대로 데이터를 추가하고 마지막에서부터 데이터를 삭제하는 것은 LinkedList보다 빠르다
 *	 하지만 중간에 데이터를 추가하려면 빈자리를 만들기 위해 다른 데이터를 복사해서 이동해야 하고
 *	 삭제인 경우에는 데이터를 재배치해야 하지만
 *	 LinkedList의 경우에는 각 요소간 연결만 변경해주면 되기 때문에 처리속도가 상당히 빠르다.
 *
