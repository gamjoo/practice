...
$(function() {
  $("button").click(function () { //버튼을 클릭하면
	  ...
	  $.ajax({
		  url : "http://www.aladin.co.kr/ttb/api/ItemSearch.aspx", //요청 전송 url
		  data : {QueryType:Title, MaxResults:10, start:1, SearchTarget:Book, output:JS, Version:20131101},
...
http://www.aladin.co.kr/ttb/api/ItemSearch.aspx?ttbkey=[TTBKey]
&Query=aladdin&QueryType=Title&MaxResults=10&start=1&SearchTarget=Book&
