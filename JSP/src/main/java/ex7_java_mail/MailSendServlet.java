...
public class MailSendServlet extends HttpServlet {
	private static final long serialVersionUID = -1831775106348995846L;
...
1. 호스트이름, 사용자명, 비밀번호 등과 같은 호스트의 모든 정보를 저장하는 Session 객체를 얻는다.
2. 메시지를 구성한다.
3. 메시지를 보낸다.
	 */
	//SMTP 서버 주소를 지정한다.
...
//메일을 보내기 위한 정보를 입력하기 위해 Message객체를 생성한다.
...
//받는 메일 주소 정보를 설정한다.
//Message.RecipientType는 Message 클래스에서 허용하는 수신자 유형을 정의한다.
